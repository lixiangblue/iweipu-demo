package org.pipework.framework.util;
...
public final class DownloadUtils {
    ...
    public static OutputStream getDownloadOutput(String name,HttpServletResponse response) {
    ...
    public static OutputStream getDownloadOutput(String flag, FileSuffix suf,HttpServletResponse response) {
        String name = genFileName(flag, suf);
        return getDownloadOutput(name,response);
    }
