 ...
 * 修改内容: 
 */
package org.pipework.framework.dao.page;

import org.pipework.framework.dao.DbTypes;
import org.pipework.framework.dao.page.mysql.MySqlPaggingDialect;
import org.pipework.framework.dao.page.oracle.OraclePaggingDialect;
import org.pipework.framework.dao.page.postgre.PostgreSqlPaggingDialect;
...
public class DefaultPaggingDialectFactory implements PaggingDialectFactory {
     ...
     * (non-Javadoc)
     * 
     * @see com.skymobi.commons.dao.page.PaggingDialectFactory#getPaggingDialect(String)
     */
    @Override
