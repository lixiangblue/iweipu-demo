 ...
 * 修改内容: 
 */
package org.pipework.framework.dao.page.oracle;

import org.pipework.framework.dao.page.DefaultPaggingDialect;
...
public class OraclePaggingDialect extends DefaultPaggingDialect {
     ...
     * (non-Javadoc)
     * 
     * @see com.skymobi.commons.dao.page.PaggingDialect#getPaggingSql(String, int, int)
     */
    @Override
